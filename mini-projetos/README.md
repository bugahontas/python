...
* Se você utiliza sistema operacional GNU/Linux, bastar dar permissão de execução ao arquivo .py com o comando `sudo chmod u+x nome_do_arquivo.py`  
